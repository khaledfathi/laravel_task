                    ...
                    <div class="card mb-3" style="border-radius: .5rem;">
                        <div class="row g-0">
                            <div class="col-md-4  gradient-custom text-center text-white"
                                ...
                                <img class= "mt-5 rounded-circle bg-primary" src="{{ $user->image ? $user->image : $defaultUserImage }}"
                                    alt="Avatar" class="img-fluid my-5" style="width: 80px;" />
                                <h5 class="my-3">{{$user->name}}</h5>
                                <a href="{{route('user.edit', $user->id)}}">
                                    <i class="bi bi-pencil-square bg-secondary p-2 rounded" style="font-size:25px;color:white"></i>
                                </a>
                            </div>
                            <div class="col-md-8">
